  ...
  async uploadResume(
    ...
    try {
      ...
      const resume = await resumeRepository.create({
        ...
        fileUrl: url,
        fileSize: file.size,
        parsedName: (parsedData.name || undefined) as any,
        parsedEmail: (parsedData.email || undefined) as any,
        parsedPhone: (parsedData.phone || undefined) as any,
        parsedSkills: (parsedData.skills || []) as any,
        parsedExperience: (parsedData.experience || []) as any,
        parsedEducation: (parsedData.education || []) as any,
        parsedProjects: (parsedData.projects || []) as any,
        parsedCertifications: (parsedData.certifications || []) as any,
        parsedLanguages: (parsedData.languages || []) as any,
      });
